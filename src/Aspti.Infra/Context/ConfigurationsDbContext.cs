...
namespace Aspti.Infra.Data.Context
{
    ...
    {
        private readonly AsptiDbContext _dbContext;
        private readonly UserManager<Usuario> _userManager;
        private readonly RoleManager<Perfil> _roleManager;

        public ConfigurationsDbContext(AsptiDbContext dbContext, UserManager<Usuario> userManager, RoleManager<Perfil> roleManager)
        {
